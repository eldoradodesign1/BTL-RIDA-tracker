...
export type UserCategory = 'hostess' | 'brand_ambassador' | 'brand_ambassador_youth' | 'operations' | 'rida_agent';
export type CampaignType = 'hostess' | 'brand_ambassador' | 'rida_installation';
export type CampaignContext = 'rida-installation' | 'vodacom-privilege' | 'merchant-educational' | 'youth-f2f';

export type RidaOsType = 'Android' | 'iOS';
export type RidaClientType = 'Passager' | 'Chauffeur' | 'Partenaire';
export type RidaPhoneBrand =
  | 'Samsung'
  | 'Tecno'
  | 'Infinix'
  | 'Apple'
...
export interface Lead {
  ...
  bundle_type?: string;
  amount?: number;
  status?: 'pending' | 'synced' | 'Installé' | 'Validé';
}
